...
class TestProgressManager:
    ...
    def test_save_progress(self, mock_json_dump, mock_open, progress_manager):
        ...
        # Call save_progress
        result = progress_manager.save_progress("/output", "/path/to/image.jpg", {"custom": "data"})
    ...
    @mock.patch("builtins.open", new_callable=mock.mock_open)
    @mock.patch("json.dump")
    def test_save_progress_with_existing_data(self, mock_json_dump, mock_open, mock_exists, progress_manager):
        ...
        mock_open.return_value.__enter__.return_value.read.return_value = json.dumps(
            {
                ...
                "annotation_history": [{"image": "/old/path.jpg", "timestamp": "2023-01-01T12:00:00"}],
            }
        )
    ...
    def test_calculate_progress(self, mock_exists, mock_glob, progress_manager):
        ...
        mock_glob.side_effect = lambda path: (
            ["/images/img1.jpg", "/images/img2.jpg", "/images/img3.jpg", "/images/img4.jpg"] if ".jpg" in path else []
        )
